...
const SelectorBetweenValues = ({ values, value, setValue }: { values: { [key in string]: string }; value: string | null; setValue: (value: any) => void }) => {
	...
	return (
		<View style={{ flex: 1, flexDirection: "row", padding: 7, backgroundColor: "#fff", borderWidth: 1, borderColor: "#00000020", borderRadius: 99 }}>
			<View style={{ flexDirection: "row", alignItems: "center", flex: 1 }}>
				{value && <Animated.View style={[animatedStyle, { width: `${100 / Object.values(values).length}%`, backgroundColor: "#00B2FF", height: 45, borderRadius: 99, position: "absolute", top: 0 }]} />}
